    ...
    <div className="w-full max-w-[400px] mt-10 md:max-w-[100%] mx-auto">
      {programs.map((item, index) => (
        <div
          ...
          className={`program-box relative cursor-pointer flex justify-between w-full rounded-[16px] pl-[10px]  xl:pl-5 shadow-[0_4px_40px_#003B631A] overflow-visible xl:overflow-visible mb-4 xl:mb-8 transition-all duration-300 ${activeIndex === index ? "h-[190px]" : "h-[144px]"
            }
